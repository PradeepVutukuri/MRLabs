...
public class MaxClosingPriceJob extends Configured implements Tool {
	...
	public static class MaxClosingPriceMapper extends TableMapper<Text, Text> {
		...
		protected void map(ImmutableBytesWritable key, Result value,
			...
			KeyValue closingPriceKV = value.getColumnLatest(PRICE_COLUMN_FAMILY, CLOSING_QUALIFIER);
			...
			outputValue.set(date + Bytes.toDouble(closingPriceKV.getValue()));
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "MaxClosingPriceJob");
