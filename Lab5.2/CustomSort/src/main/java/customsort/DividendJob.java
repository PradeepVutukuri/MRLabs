...
public class DividendJob extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		MultipleOutputs.addNamedOutput(job, "positive", TextOutputFormat.class, Text.class, DividendChange.class);
		MultipleOutputs.addNamedOutput(job, "negative", TextOutputFormat.class, Text.class, DividendChange.class);
